(asdf:defsystem #:autolith
  ...
  :components ((:module "src"
                ...
                :components ((:file "core/package")
                             ...
                             (:file "provider/devin/protobuf")
                             (:file "provider/devin/wire")
                             (:file "provider/devin/authentication")
                             (:file "provider/devin/client")
                             ...
                             (:file "state/data-transfer")
                             (:file "state/data-transfer-collect")
                             (:file "state/data-transfer-validate")
